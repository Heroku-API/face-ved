...
global count
size=(1920,1080)
# result = cv2.VideoWriter('face_recognition_4.avi',
#                          cv2.VideoWriter_fourcc(*'MJPG'),
#                          25, size)

def build_argparser(source):
    parser = ArgumentParser()
    # input=r"D:\face_recognition_demo\amazon-rekognition-800x509.jpg"
    # input=r"D:\downloads\filename_one.avi"
    #input=r"C:\Users\Admin\Desktop\D51_20220909181158_Trim_one_now.mp4"
    ...
    general.add_argument('-i', '--input', default=source,required=False,
    ...
    gallery.add_argument('-fg', default=r'C:\Users\Keerthika\Desktop\face_recognition\face-trial\faces', help='Optional. Path to the face images directory.')
    gallery.add_argument('--run_detector', action='store_true',default=False,
                         help='Optional. Use Face Detection model to find faces '
                              'on the face images, otherwise use full images.')
    gallery.add_argument('--allow_grow', action='store_true',default=True,
    ...
    infer.add_argument('-t_id', metavar='[0..1]', type=float, default=0.8,
...
def main(source):
    args = build_argparser(source).parse_args()
