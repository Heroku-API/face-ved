...
def build_argparser():
    ...
    general.add_argument('-i', '--input', default=input,required=False,
    ...
    gallery.add_argument('-fg', default='face_nexgen', help='Optional. Path to the face images directory.')
    ...
    gallery.add_argument('--allow_grow', action='store_true',default=False,
